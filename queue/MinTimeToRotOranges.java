            ...
            { 
                ...
                if (isValid(temp.x-1, temp.y) && arr[temp.x-1][temp.y] == 1) 
                 { 
                        ...
                        Q.add(new Ele(temp.x - 1,temp.y)); // push this cell to Queue 
                ...
                // Check top adjacent cell that if it can be rotten 
                 if (isValid(temp.x, temp.y+1) && arr[temp.x][temp.y+1] == 1) { 
                        ...
                        Q.add(new Ele(temp.x,temp.y+1)); // Push this cell to Queue 
                 ...
                 // for removing the element which was stored in temp because all its adjacent nodes are present
                 Q.remove(); 
